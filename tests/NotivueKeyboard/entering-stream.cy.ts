describe('Entering the stream', () => {
   ...
   it('If an unqualified element is pushed, it should not be focused if tab is pressed', () => {
      cy.mountKeyboard()
         .pushUnqualified()
   ...
   it('If never navigated and unqualified are pushed after candidates, the first candidate should be focused if tab is pressed', () => {
      cy.mountKeyboard()
